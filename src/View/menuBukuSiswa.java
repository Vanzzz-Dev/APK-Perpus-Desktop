...
DefaultTableModel model;
    ...
    public menuBukuSiswa() {
      ...
      conn = koneksi.koneksi.KoneksiDB();
        ...
        new Object[]{"Judul Buku","Pengarang","Tahun Terbit","Kategori","Penerbit","Gambar"}, 0
    );
    ...
    "SELECT bk.Judul_Buku, bk.Pengarang_Buku, bk.Tahun_Terbit, " +
    "ktg.Nama_Kategori, pnb.Nama_Penerbit,bk.Gambar " +
    "FROM buku bk " +
...
ps.setInt(2, offset);
        ...
        imageIcon = new ImageIcon(img);
            ...
            Object[] rowData = {judulBuku, pengarangBuku, tahunTerbit, namaKategori,  namaPenerbit,imageIcon};
    ...
    public Component getTableCellRendererComponent(
     ...
     private void serchData() {
       ...
       .setCellRenderer(new ImageRender());
        ...
        try{
        String sql = "SELECT bk.Judul_Buku, bk.Pengarang_Buku,bk.Tahun_Terbit, ktg.Nama_Kategori, pnb.Nama_Penerbit, bk.Gambar \n" +
                     "FROM buku bk \n" +
                     "INNER JOIN kategori ktg ON ktg.ID_Kategori = bk.ID_Kategori \n" +
                     "INNER JOIN penerbit pnb ON pnb.ID_Penerbit = bk.ID_Penerbit \n" +

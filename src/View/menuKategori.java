...
DefaultTableModel model;
    ...
    public menuKategori() {
        ...
        new Object[]{"ID","Nama Kategori","Deskripsi Kategori"}, 0
    );
 ...
 setColumnWitdh();
    ...
    public void setLayout(){
        ...
        txtNama.putClientProperty(FlatClientProperties.PLACEHOLDER_TEXT, "Nama Kategori");
        txtEmail.putClientProperty(FlatClientProperties.PLACEHOLDER_TEXT, "Deskripsi Kategori");
      }
    
    void hitungTotalData() {
    try {
        ps = conn.prepareStatement("SELECT COUNT(*) FROM Kategori");
        rs = ps.executeQuery();
        if (rs.next()) {
    ...
    private void initComponents() {
        ...
        jLabel13.setText("Data Kategori Buku Perpustakaan");

        jLabel14.setFont(new java.awt.Font("Bahnschrift", 1, 12)); // NOI18N
        jLabel14.setText("Master Data > Kategori");

        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/kategori.png"))); // NOI18N
        ...
        jLabel15.setText("Tambah Data Kategori Buku Perpustakaan");

        jLabel16.setFont(new java.awt.Font("Bahnschrift", 1, 12)); // NOI18N
        jLabel16.setText("Master Data > Kategori");

        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/kategori.png"))); // NOI18N
 ...
 private String setIDKategori() {
    ...
    try (PreparedStatement st = conn.prepareStatement(sql)) {
        ...
        java.util.logging.Logger
            .getLogger(menuKategori.class.getName())
    ...
    private void insertData() {
        String idKategori = txtID.getText();
        String namaKategori = txtNama.getText();
        String deskripsiKategori = txtEmail.getText();
    ...
    jLabel15.setText("Perbarui Data Kategori Perpustakaan");
